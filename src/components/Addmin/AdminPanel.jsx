  ...
  return (
    <div className="dashboard-container">
      <div className="sidebarAdmin">
        ...
        <button onClick={() => handleOptionSelect('Partners')}><FaPeopleArrows />&nbsp; Manage Partners</button>
        <button onClick={() => handleOptionSelect('Guides and Events')}><MdEventAvailable />&nbsp; Manage Guides and Events</button>
